    ...
    return (
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8">
        ...
        >
          ...
          <div className="relative flex flex-col justify-center p-8 sm:p-12 md:p-14 bg-gradient-to-br from-primary/10 via-secondary/5 to-transparent border-b md:border-b-0 md:border-r border-border overflow-hidden" style={{
            backgroundImage: "var(--login-split-left-bg-image)",
            backgroundColor: "var(--login-split-left-bg)",
